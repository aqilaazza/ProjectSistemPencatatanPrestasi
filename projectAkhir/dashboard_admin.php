...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="#" onclick="showSection('biodata_admin')">Biodata Admin</a></li>
            <li><a href="#" onclick="showSection('biodata_dosen')">Biodata Dosen</a></li>
            <li><a href="#" onclick="showSection('biodata_mahasiswa')">Biodata Mahasiswa</a></li>
