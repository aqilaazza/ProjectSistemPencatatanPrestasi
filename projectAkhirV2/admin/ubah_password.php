...
// Periksa apakah mahasiswa sudah login (misalnya dengan memeriksa session nip)
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $nip = $_POST['nip']; // NIP yang diambil dari input form (tetap dari session)
    ...
    $query = "UPDATE login_admin SET password = :password WHERE nip = :nip";
...
<body>
    <div class="container">
        ...
        <form action="#" method="POST">
            ...
            <!-- Input NIP otomatis dari session dan tidak bisa diubah -->
            <input type="text" name="nip" value="<?= $nip_login ?>" readonly />
