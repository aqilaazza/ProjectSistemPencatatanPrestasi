...
// Periksa apakah mahasiswa sudah login (misalnya dengan memeriksa session nidn)
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $nidn = $_POST['nidn']; // NIDN yang diambil dari input form (tetap dari session)
    ...
    $query = "UPDATE login_dosen SET password = :password WHERE nidn = :nidn";
...
<body>
    <div class="container">
        ...
        <form action="#" method="POST">
            ...
            <!-- Input NIDN otomatis dari session dan tidak bisa diubah -->
            <input type="text" name="nidn" value="<?= $nidn_login ?>" readonly />
